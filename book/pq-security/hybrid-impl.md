...
ในปัจจุบัน Internet Engineering Task Force (IETF) กำลังพัฒนามาตรฐาน [Post-quantum hybrid ECDHE-MLKEM Key Agreement for TLSv1.3](https://datatracker.ietf.org/doc/draft-kwiatkowski-tls-ecdhe-mlkem/) โดยผสมผสานอัลกอริทึม Elliptic-curve Diffie–Hellman (ECDH) ซึ่งเป็นอัลกอริทึมแบบดั้งเดิม เข้ากับ ML-KEM ซึ่งเป็นอัลกอริทึม PQC เพื่อให้ TLS 1.3 ปลอดภัยทั้งจากคอมพิวเตอร์ปัจจุบันและคอมพิวเตอร์ควอนตัมในอนาคต โดยระบบจะมีความปลอดภัยตราบใดที่อย่างน้อยหนึ่งในสองอัลกอริทึมยังไม่ถูกโจมตีได้
