...
ในปัจจุบัน Internet Engineering Task Force (IETF) กำลังพัฒนามาตรฐาน [Post-quantum hybrid ECDHE-MLKEM Key Agreement for TLSv1.3](https://datatracker.ietf.org/doc/draft-kwiatkowski-tls-ecdhe-mlkem/) โดยผสมผสานอัลกอริทึม Elliptic-curve Diffie–Hellman (ECDH) ซึ่งเป็นอังกอริทึมแบบดั่งเดิม เข้ากับ ML-KEM ซึ่งเป็นอัลกอริทึม PQC เพื่อให้ TLS 1.3 ปลอดภัยทั้งจากคอมพิวเตอร์ปัจจุบันและคอมพิวเตอร์ควอนตัมในอนาคต โดยระบบจะมีความปลอดภัยตราบใดที่อย่างน้อยหนึ่งในสองอัลกอริทึมยังไม่ถูกโจมตีได้
...
ใบรับรองดิจิทัลแบบผสม (Hybrid Digital Certificate) เป็นองค์ประกอบสำคัญในการใช้งาน การสร้างกุญแจรหัสลับร่วมกันแบบผสม และ การลงลายมือชื่อดิจิทัลแบบผสม โดยรวมอัลกอริทึมแบบดั้งเดิมและแบบ QPC ไว้ใน ใบรับรองดิจิทัล X.509 เดียวกัน เพื่อให้ยังคงใช้งานร่วมกับระบบเดิมได้ ขณะเดียวกันก็เพิ่มความมั่นคงปลอดภัยในระยะยาว ทำให้มีความเหมาะกับการใช้งานในระยะยาว (long-lived credentials) โดยใบรับรองดิจิทัลแบบผสมสามารถแบ่่งเป็นประเภทต่าง ๆ ได้ดังนี้ {cite:p}`ricchizzi2025applied`
